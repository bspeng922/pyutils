...
class MyFrame(wx.Frame):
    def __init__(self):
        ...
        stopBtn = wx.Button(panel, -1, "stop a thread")
        self.tc = wx.StaticText(panel, -1, 'working: 00')
    ...
    def UpdateCount(self):
        self.tc.SetLabel("working: %d"%len(self.threads))
