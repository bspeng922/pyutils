...
class Example(wx.Frame):
    def __init__(self, parent, id):
        wx.Frame.__init__(self, parent, id, "  ", size=(450,350))
        self.Center()
        self.InitUI()
    ...
    def InitUI(self):
        ...
        icon = wx.StaticBitmap(panel, bitmap=wx.Bitmap('convert.ico'))
        ...
        button1 = wx.Button(panel, label="Browser...")
        ...
        button2 = wx.Button(panel, label="Browser...")
        ...
        sizer.AddGrowableCol(1)    #the 2th col will grow ; 2 is ok too
        #sizer.AddGrowableRow(5)  #the 5th row will grow when windows size changed
